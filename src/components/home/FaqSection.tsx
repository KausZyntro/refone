...
const FAQSection = () => {
  ...
  const [limit, setLimit] = useState(6); // Default for mobile to avoid hydration mismatch
      ...
      <div className="faq-container">
        <div className="faq-header">
          <div className="faq-title-wrapper">
            {/* <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="faq-badge-icon">
              ...
              <path d="M15 9L11 14L9 12" stroke="#333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg> */}
        ...
        <div className="faq-content-wrapper">
              ...
              >
                ...
                >
                  ...
                  <span className="faq-icon">
                    {activeIndex === index ? (
                      <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 7L7 1L13 7" stroke="#333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    ) : (
                      <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1L7 7L13 1" stroke="#333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    )}
                  </span>
                </div>
          ...
          <div className="faq-image-container">
            <img src="/faq_hero.png" alt="FAQ Illustration" />
          </div>
        </div>
